...
const Footer = () => {
    ...
    return (
        <footer className="bg-gradient-to-r from-[#5E7ADD] to-[#2D3985] text-white py-8">
            <div className="px-[48px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-24">
                {/* Kolom Kiri */}
                        ...
                        <div className="flex items-start mb-4">
                            ...
                            <p className="text-base">
                                <span className="font-bold text-[14px]">
                                    Gedung Roeslan Abdulgani Kementerian Luar
                                    Negeri RI.
                                </span>
                                <br />
                                <span className="font-reguler text-[14px]">
                                    Jl. Taman Pejambon No. 6, Senen, Jakarta
                                    Pusat, DKI Jakarta, 10410
                                </span>
                            </p>
                        </div>
